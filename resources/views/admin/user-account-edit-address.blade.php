<x-admin-layout>
    @section('title', 'Manage User Addresses - Timplato')
        ...
        <div class="card p-4 shadow-sm">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div class="fw-semibold fs-5">
                    Manage Addresses — {{ $user->getFullName() }}
                </div>

                <div>
                    <a href="{{ route('admin.user-account-view', ['id' => $user->id]) }}"
                            ...
                            @foreach ($addresses as $address)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form
                                            action="{{ route('admin.users.addresses.destroy', [$user->id, $address->address_id]) }}"
                                ...
                                <div class="modal fade" id="editAddressModal{{ $address->address_id }}" tabindex="-1">
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <form
                                                action="{{ route('admin.users.addresses.update', [$user->id, $address->address_id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('PUT')
    ...
    <div class="modal fade" id="addAddressModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ route('admin.users.addresses.store', $user->id) }}" method="POST">
                    @csrf
                    <div class="modal-header">
